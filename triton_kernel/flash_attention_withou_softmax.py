...
triton_attention_wo_softmax = _attention.apply
...
def test_op(Z, H, N_CTX, HEAD_DIM, causal, dtype=torch.float16):
    ...
    # For details see https://pytorch.ac.cn/docs/stable/notes/numerical_accuracy.html#reduced-precision-fp16-and-bf16-gemms-and-convolutions-on-amd-instinct-mi200-devices
...
if __name__ == "__main__":
    ...
    bench_flash_attention.run(print_data=True, save_path="./data/")